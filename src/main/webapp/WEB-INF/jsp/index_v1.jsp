...
<head>
    ...
    <link rel="shortcut icon" href="${APP_PATH}/img/favicon.ico"> <link href="${APP_PATH}/css/bootstrap.min.css?v=3.3.5" rel="stylesheet">
...
<body class="gray-bg">
    <div class="row  border-bottom white-bg dashboard-header">
        ...
        <div class="col-sm-3">
            ...
            <br>
            <br>
            <img src="${APP_PATH}/img/qr_code.png" width="100%" style="max-width:264px;">
            <br>
        </div>
        <div class="col-sm-5">
            <h2>
    ...
    <script src="${APP_PATH}/js/content.min.js"></script>
    <script src="${APP_PATH}/js/welcome.min.js"></script>
</body>
