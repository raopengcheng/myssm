...
<body class="fixed-sidebar full-height-layout gray-bg" style="overflow:hidden">
    <div id="wrapper">
                ...
                <ul class="nav" id="side-menu">
                    <li class="nav-header">
                        <div class="dropdown profile-element">
                            <span><img alt="image" class="img-circle" src="${APP_PATH }/img/profile_small.jpg" /></span>
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a class="J_menuItem" href="${APP_PATH }/WEB-INF/index_v1.jsp" data-index="0">主页示例一</a>
                            </li>
                            <li>
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li><a class="J_menuItem" href="userList">人员信息查询</a>
                            </li>
                        </ul>
                    </li>
                    <li>
        ...
        <div id="page-wrapper" class="gray-bg dashbard-1">
            <div class="row border-bottom">
                <nav class="navbar navbar-static-top" role="navigation" style="margin-bottom: 0">
                    ...
                    <ul class="nav navbar-top-links navbar-right">
                        ...
                        <li class="hidden-xs">
                            <a href="${APP_PATH }/WEB-INF/index_v1.jsp" class="J_menuItem" data-index="0"><i class="fa fa-cart-arrow-down"></i> 购买</a>
                        </li>
            ...
            <div class="row content-tabs">
                ...
                <nav class="page-tabs J_menuTabs">
                    <div class="page-tabs-content">
                        <a href="javascript:;" class="active J_menuTab" data-id="${APP_PATH }/WEB-INF/index_v1.jsp">首页</a>
                    </div>
                </nav>
            ...
            <div class="row J_mainContent" id="content-main">
                <iframe class="J_iframe" name="iframe0" width="100%" height="100%" src="${APP_PATH }/WEB-INF/index_v1.jsp?v=4.0" frameborder="0" data-id="${APP_PATH }/WEB-INF/index_v1.jsp" seamless></iframe>
            </div>
            <div class="footer">
    ...
    <script src="${APP_PATH }/js/plugins/metisMenu/jquery.metisMenu.js"></script>
    <script src="${APP_PATH }/js/plugins/slimscroll/jquery.slimscroll.min.js"></script>
    <script src="${APP_PATH }/js/plugins/layer/layer.min.js"></script>
    <script src="${APP_PATH }/js/hplus.min.js?v=4.0.0"></script>
    <script type="text/javascript" src="${APP_PATH }/js/contabs.min.js"></script>
    <script src="${APP_PATH }/js/plugins/pace/pace.min.js"></script>
</body>
